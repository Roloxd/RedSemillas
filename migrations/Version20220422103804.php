 ...
 */
final class Version20220422103804 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // $this->addSql('ALTER TABLE entrada ADD url VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        // $this->addSql('ALTER TABLE entrada DROP url');
