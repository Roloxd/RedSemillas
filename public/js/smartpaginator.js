    ...
    $.fn.extend({
        smartpaginator: function (options) {
            ...
            return this.each(function () {
                ...
                var container = $(this).addClass('pager').addClass('marron');
                ...
                var btnPrev = $('<div/>').text('❮').click(function () { 
                ...
                var btnNext = $('<div/>').text('❯').click(function () { 
                    if ($(this).hasClass('disabled')) return false; 
                ...
                var btnFirst = $('<div/>').text('❰❰').click(function () { 
                    if ($(this).hasClass('disabled')) return false; 
                    currentPage = 0; 
                    navigate(0);
                    $('body, html').animate({
                ...
                var btnLast = $('<div/>').text('❱❱').click(function () { 
                    if ($(this).hasClass('disabled')) return false; 
                ...
                var btnGo = $('<input/>').attr('type', 'button').attr('value', 'Ir').addClass('btn').click(function () { 
                    if (inputPage.val() == '') return false; 
                    else { currentPage = parseInt(inputPage.val()) - 1; navigate(currentPage); }
                    $('body, html').animate({
                        scrollTop: '0px'
                    }, 300);
                });

                var btnDisable = $('<div/>').text("Mostrar todo").click(function () { 
                    $('.variedad').show();
                }).addClass('btn btnDisable');

                container.append(btnDisable).append(btnFirst).append(btnPrev).append(list).append(btnNext).append(btnLast).append($('<div/>').addClass('short').append(inputPage).append(btnGo));
                ...
                function buildNavigation(startPage) {
                    ...
                    for (var i = startPage; i < startPage + settings.length; i++) {
                        ...
                        list.append($('<li/>')
                                    .append($('<a>').attr('id', (i + 1)).addClass('marron').addClass('normal')
                    ...
                    list.find('li a').addClass('marron').removeClass('active');
                    list.find('li:eq(0) a').addClass('marron').addClass('active');
